...
import be.cytomine.appengine.dto.responses.errors.details.*;
...
public class ErrorBuilder {
    ...
    public static AppEngineError buildWithMessage(ErrorCode code, String message ,BaseErrorDetails details) {
        MessageCode container = ErrorDefinitions.fromCode(code);
     ...
     * @param errors list of underlying errors, each error corresponds to an item of the batch
     */
     ...
     */
    public static AppEngineError buildParamRelatedError(ErrorCode code, String paramName, String description) {
