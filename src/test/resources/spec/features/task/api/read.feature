Feature: [URS00002-TASK] Read task information
  ...
  - '/tasks/{namespace}/{version}/descriptor.yml'
    ...
    Examples:
      ...
      | Enum task    | com.cytomine.dummy.identity.enumeration        | 1.0.0        | acde070d-8c4c-4f0d-9d8a-162843c10333 | task-acde070d-8c4c-4f0d-9d8a-162843c10333-def |
  ...
  - '/tasks/{namespace}/{version}'
    ...
    Examples:
      ...
      | Task 2 | com.cytomine.dummy.identity.enumeration        | 1.0.0        |
  ...
  - '/tasks/{namespace}/{version}/inputs'
    ...
    Examples:
      ...
      | Task 1 | com.cytomine.dummy.arithmetic.integer.addition | 1.0.0        |
      | Task 2 | com.cytomine.dummy.identity.boolean            | 1.0.0        |
      | Enum task    | com.cytomine.dummy.identity.enumeration        | 1.0.0        |
