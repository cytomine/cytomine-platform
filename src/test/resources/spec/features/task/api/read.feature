Feature: [URS00002-TASK] Read task information
  ...
  - '/tasks/{namespace}/{version}/descriptor.yml'
    ...
    Examples:
      ...
      | Task 8 | com.cytomine.dummy.identity.array.integer      | 1.0.0        | acde070d-8c4c-4f0d-9d8a-162843c10333 | task-acde070d-8c4c-4f0d-9d8a-162843c10333-def |
  ...
  - '/tasks/{namespace}/{version}'
    ...
    Examples:
      ...
      | Task 8 | com.cytomine.dummy.identity.array.integer      | 1.0.0        |
  ...
  - '/tasks/{namespace}/{version}/outputs'
    ...
    Examples:
      ...
      | Task 6 | com.cytomine.dummy.identity.geometry           | 1.0.0        |
      | Task 7 | com.cytomine.dummy.identity.image              | 1.0.0        |
      | Task 7 | com.cytomine.dummy.identity.array.integer      | 1.0.0        |
