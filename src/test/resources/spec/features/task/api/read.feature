Feature: [URS00002-TASK] Read task information
  ...
  - '/tasks/{namespace}/{version}/descriptor.yml'
    ...
    Examples:
      ...
      | Task 2 | com.cytomine.dummy.identity.datetime           | 1.0.0        | acde070d-8c4c-4f0d-9d8a-162843c10333 | task-acde070d-8c4c-4f0d-9d8a-162843c10333-def |
  ...
  - '/tasks/{namespace}/{version}'
    ...
    Examples:
      ...
      | Task 2 | com.cytomine.dummy.identity.datetime           | 1.0.0        |
