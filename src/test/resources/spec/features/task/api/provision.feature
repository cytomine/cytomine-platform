Feature: [URS00003-TASK] Provision a task run
  ...
  - '/task-runs/{run_id}/input-provisions/{param_name}'
    ...
    Examples:
      ...
      | com.cytomine.dummy.identity.geometry           | 1.0.0        | input      | geometry    | {\"param_name\": \"input\", \"value\": { \"type\": \"Feature\", \"geometry\": { \"type\": \"MultiPoint\", \"coordinates\": [[1.0, 2.0], [2.0, 3.0]] }, \"properties\": {}}}                                                                                                                     | { \"type\": \"Feature\", \"geometry\": { \"type\": \"MultiPoint\", \"coordinates\": [[1.0, 2.0], [2.0, 3.0]] }, \"properties\": {}}                                                                                                                     | CREATED                | PROVISIONED        | { \"type\": \"Feature\", \"geometry\": { \"type\": \"MultiPoint\", \"coordinates\": [[1.0, 2.0], [2.0, 3.0]] }, \"properties\": {}}                                                                                                                     |
      | com.cytomine.dummy.identity.geometry           | 1.0.0        | input      | geometry    | {\"param_name\": \"input\", \"value\": { \"type\": \"Feature\", \"geometry\": { \"type\": \"LineString\", \"coordinates\": [[1.0, 2.0], [2.0, 3.0]] }, \"properties\": {}}}                                                                                                                     | { \"type\": \"Feature\", \"geometry\": { \"type\": \"LineString\", \"coordinates\": [[1.0, 2.0], [2.0, 3.0]] }, \"properties\": {}}                                                                                                                     | CREATED                | PROVISIONED        | { \"type\": \"Feature\", \"geometry\": { \"type\": \"LineString\", \"coordinates\": [[1.0, 2.0], [2.0, 3.0]] }, \"properties\": {}}                                                                                                                     |
      | com.cytomine.dummy.identity.geometry           | 1.0.0        | input      | geometry    | {\"param_name\": \"input\", \"value\": { \"type\": \"Feature\", \"geometry\": { \"type\": \"MultiLineString\", \"coordinates\": [[[1.0, 2.0], [2.0, 3.0]], [[5.0, 2.0], [6.0, 3.0]]] }, \"properties\": {}}}                                                                                    | { \"type\": \"Feature\", \"geometry\": { \"type\": \"MultiLineString\", \"coordinates\": [[[1.0, 2.0], [2.0, 3.0]], [[5.0, 2.0], [6.0, 3.0]]] }, \"properties\": {}}                                                                                    | CREATED                | PROVISIONED        | { \"type\": \"Feature\", \"geometry\": { \"type\": \"MultiLineString\", \"coordinates\": [[[1.0, 2.0], [2.0, 3.0]], [[5.0, 2.0], [6.0, 3.0]]] }, \"properties\": {}}                                                                                    |
      | com.cytomine.dummy.identity.geometry           | 1.0.0        | input      | geometry    | {\"param_name\": \"input\", \"value\": { \"type\": \"Feature\", \"geometry\": { \"type\": \"Polygon\", \"coordinates\": [[[10.0, 0.0], [11.0, 0.0], [11.0, 1.0], [10.0, 1.0], [10.0, 0.0]]] }, \"properties\": {}}}                                                                             | { \"type\": \"Feature\", \"geometry\": { \"type\": \"Polygon\", \"coordinates\": [[[10.0, 0.0], [11.0, 0.0], [11.0, 1.0], [10.0, 1.0], [10.0, 0.0]]] }, \"properties\": {}}                                                                             | CREATED                | PROVISIONED        | { \"type\": \"Feature\", \"geometry\": { \"type\": \"Polygon\", \"coordinates\": [[[10.0, 0.0], [11.0, 0.0], [11.0, 1.0], [10.0, 1.0], [10.0, 0.0]]] }, \"properties\": {}}                                                                             |
      | com.cytomine.dummy.identity.geometry           | 1.0.0        | input      | geometry    | {\"param_name\": \"input\", \"value\": { \"type\": \"Feature\", \"geometry\": { \"type\": \"MultiPolygon\", \"coordinates\": [[[[12.0, 2.0], [13.0, 2.0], [13.0, 3.0], [12.0, 3.0], [12.0, 2.0]]], [[[10.0, 0.0], [11.0, 0.0], [11.0, 1.0], [10.0, 1.0], [10.0, 0.0]]]] }, \"properties\": {}}} | { \"type\": \"Feature\", \"geometry\": { \"type\": \"MultiPolygon\", \"coordinates\": [[[[12.0, 2.0], [13.0, 2.0], [13.0, 3.0], [12.0, 3.0], [12.0, 2.0]]], [[[10.0, 0.0], [11.0, 0.0], [11.0, 1.0], [10.0, 1.0], [10.0, 0.0]]]] }, \"properties\": {}} | CREATED                | PROVISIONED        | { \"type\": \"Feature\", \"geometry\": { \"type\": \"MultiPolygon\", \"coordinates\": [[[[12.0, 2.0], [13.0, 2.0], [13.0, 3.0], [12.0, 3.0], [12.0, 2.0]]], [[[10.0, 0.0], [11.0, 0.0], [11.0, 1.0], [10.0, 1.0], [10.0, 0.0]]]] }, \"properties\": {}} |
      | com.cytomine.dummy.identity.geometry           | 1.0.0        | input      | geometry    | {\"param_name\": \"input\", \"value\": { \"type\": \"Feature\", \"geometry\": { \"type\": \"Point\", \"coordinates\": [-122.126986, 47.639754] }, \"properties\": {\"subType\": \"Circle\", \"radius\": 100}}}                                                                                  | { \"type\": \"Feature\", \"geometry\": { \"type\": \"Point\", \"coordinates\": [-122.126986, 47.639754] }, \"properties\": {\"subType\": \"Circle\", \"radius\": 100}}                                                                                  | CREATED                | PROVISIONED        | { \"type\": \"Feature\", \"geometry\": { \"type\": \"Point\", \"coordinates\": [-122.126986, 47.639754] }, \"properties\": {\"subType\": \"Circle\", \"radius\": 100}}                                                                                  |
  ...
  - '/task-runs/{run_id}/input-provisions/{parameter}'
    ...
    Examples:
      ...
      | com.cytomine.dummy.identity.enumeration        | 1.0.0        | A                                                   | my_input           | {\"param_name\": \"my_input\", \"value\": A}                                                | CREATED                | {\"error_code\": \"APPE-internal-parameter-not-found\", \"message\": \"parameter not found\", \"details\": {\"param_name\": \"my_input\"}}  |
      ...
      | com.cytomine.dummy.identity.geometry           | 1.0.0        | { \"type\": \"Point\", \"coordinates\": [1.0, 1.0]} | my_input           | {\"param_name\": \"input\", \"value\": { \"type\": \"Point\", \"coordinates\": [1.0, 1.0]}} | CREATED                | {\"error_code\": \"APPE-internal-parameter-not-found\", \"message\": \"parameter not found\", \"details\": {\"param_name\": \"my_input\"}}  |
  ...
  - '/task-runs/{run_id}/input-provisions'
    ...
    Examples:
      ...
      | com.cytomine.dummy.identity.geometry           | 1.0.0        | input      | geometry    | {\"type\": \"Feature\", \"geometry\": {\"type\": \"Point\", \"coordinates\": [1.0, 1.0]}, \"properties\": {}} | {\"type\": \"Feature\", \"geometry\": {\"type\": \"Point\", \"coordinates\": [2.0, 2.0]}, \"properties\": {}} | {\"param_name\": \"input\", \"value\": {\"type\": \"Feature\", \"geometry\": {\"type\": \"Point\", \"coordinates\": [2.0, 2.0]}, \"properties\": {}}} | PROVISIONED    | {\"type\": \"Feature\", \"geometry\": {\"type\": \"Point\", \"coordinates\": [1.0, 1.0]}, \"properties\": {}} | {\"type\": \"Feature\", \"geometry\": {\"type\": \"Point\", \"coordinates\": [2.0, 2.0]}, \"properties\": {}} |
