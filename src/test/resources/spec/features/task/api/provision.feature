Feature: [URS00003-TASK] Provision a task run
  ...
  - '/task-runs/{run_id}/input-provisions/{param_name}'
    ...
    Examples:
      ...
      | com.cytomine.dummy.identity.array.integer      | 1.0.0        | input      | array       | {\"param_name\": \"input\", \"value\": [0, 1, -1, 5]}                                                                                                                                                                               | [0, 1, -1, 5]                                                                                                                                                                               | CREATED                | PROVISIONED        | 0\n1\n-1\n5                                                                                                                                                                                 |
  ...
  - '/task-runs/{run_id}/input-provisions/{parameter}'
    ...
    Examples:
      ...
      | com.cytomine.dummy.identity.array.integer      | 1.0.0        | [1, 1, 2]                                           | my_input           | {\"param_name\": \"my_input\", \"value\": [1, 1, 2]}                                        | CREATED                | {\"error_code\": \"APPE-internal-parameter-not-found\", \"message\": \"parameter not found\", \"details\": {\"param_name\": \"my_input\"}}  |
  ...
  - '/task-runs/{run_id}/input-provisions'
    ...
    Examples:
      ...
      | com.cytomine.dummy.identity.array.integer      | 1.0.0        | input      | array       | [1, 1, 2]                                          | [-1, 1, 2]                                         | {\"param_name\": \"b\", \"value\": [-1, 1, 2]}                                             | PROVISIONED    | 1\n1\n2                                            | -1\n1\n2                                           |
