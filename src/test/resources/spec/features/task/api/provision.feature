Feature: [URS00003-TASK] Provision a task run
  ...
  - '/tasks/{namespace}/{version}/runs'
    ...
    Examples:
      ...
      | com.cytomine.dummy.identity.wsi                   | 1.0.0        | /task/namespace/version/runs |
      ...
      | com.uliege.dummy.identity.integer.collection      | 0.1.0        | /task/namespace/version/runs |
      | com.uliege.dummy.identity.integer.collection      | 0.1.0        | /task/id/runs                |
  ...
  - '/task-runs/{run_id}/input-provisions/{param_name}'
    ...
    Examples:
      ...
      | com.uliege.dummy.identity.integer.collection   | 0.1.0        | input      | array       | {\"param_name\": \"input\", \"value\": [ { \"index\": 0, \"value\": 100 }, { \"index\": 1, \"value\": 200 } ] }                                                                                                                     | [ { \"index\": 0, \"value\": 100 }, { \"index\": 1, \"value\": 200 } ]                                                                                                                                                                                 | CREATED                | PROVISIONED        | directory                                                                                                                                                                                   |
  ...
  - '/task-runs/{run_id}/input-provisions/{parameter}'
    ...
    Examples:
      ...
      | com.uliege.dummy.identity.integer.collection   | 0.1.0        | [1, 1, 2]                                           | my_input           | array              |{\"param_name\": \"my_input\", \"value\": [1, 1, 2]}                                         | CREATED                | {\"error_code\": \"APPE-internal-parameter-not-found\", \"message\": \"parameter not found\", \"details\": {\"param_name\": \"my_input\"}}  |
  ...
  - '/task-runs/{run_id}/input-provisions/{param_name}'
    ...
    Examples:
      ...
      | com.uliege.dummy.identity.file.collection      | 0.1.0        | input      | file       | item       | 0     | some_random_value       | CREATED                | PROVISIONED        | content             |
