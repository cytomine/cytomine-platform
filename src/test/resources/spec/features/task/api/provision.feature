Feature: [URS00003-TASK] Provision a task run
  ...
  - '/task-runs/{run_id}/input-provisions/{param_name}'
    ...
    Examples:
      ...
      | com.cytomine.dummy.identity.enumeration        | 1.0.0        | input      | enumeration | {\"param_name\": \"input\", \"value\": "ENUMITEM"} | ENUMITEM    | CREATED                | PROVISIONED        | ENUMITEM           |
  ...
  - '/task-runs/{run_id}/input-provisions/{parameter}'
    ...
    Examples:
      ...
      | com.cytomine.dummy.identity.enumeration        | 1.0.0        | ENUMITEM             | my_input           | {\"param_name\": \"my_input\", \"value\": "ENUMITEM"} | CREATED                | {\"error_code\": \"APPE-internal-parameter-not-found\", \"message\": \"parameter not found\", \"details\": {\"param_name\": \"my_input\"}}  |
  ...
  - '/task-runs/{run_id}/input-provisions'
    ...
    Examples:
      ...
      | com.cytomine.dummy.identity.enumeration        | 1.0.0        | input      | enumeration | ENUMITEM1           | ENUMITEM2       | {\"param_name\": \"b\", \"value\": "ENUMITEM2"} | PROVISIONED    | ENUMITEM1                  | ENUMITEM2              |
