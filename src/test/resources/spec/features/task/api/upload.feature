Feature: [URS00001-TASK] Upload a task
  ...
  Scenario Outline: successful valid task upload
    ...
    Examples:
      ...
      | com.cytomine.dummy.identity.array.integer      | 1.0.0        | image.tar    | acde070d-8c4c-4f0d-9d8a-162843c10333 | task-acde070d-8c4c-4f0d-9d8a-162843c10333-def | com/cytomine/dummy/identity/array/integer:1.0.0      |
  ...
  Scenario Outline: unsuccessful upload of duplicate task
    ...
    Examples:
      ...
      | com.cytomine.dummy.identity.array.integer      | 1.0.0        |
